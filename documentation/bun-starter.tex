...
bun --hot serve.ts    # run dev server at localhost:3000

                      # build production binary
bun build --compile serve.ts --outfile=server
\end{lstlisting}

The \texttt{--hot} flag reloads on file changes. The compiled binary is self-contained and runs without Bun installed.
